...
describe OcflTools::OcflValidator do
  ...
  describe 'check results' do
    ...
    it 'expects results.ok to be 14' do
      expect(validate_a.results.ok_count).to eq 14
    end
  end
